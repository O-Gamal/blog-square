...
export const extentdedApiSlice = api.injectEndpoints({
  endpoints: (builder) => ({
...
export const selectArticlesRes =
  extentdedApiSlice.endpoints.getArticles.select();
